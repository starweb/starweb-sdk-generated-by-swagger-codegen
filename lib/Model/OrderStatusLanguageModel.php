...
/**
 * OrderStatusLanguageModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderStatusLanguageModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderStatusLanguageModel';
    ...
    protected static $setters = [
        'lang_code' => 'setLangCode''name' => 'setName'
    ];
    ...
    protected static $getters = [
        'lang_code' => 'getLangCode''name' => 'getName'
    ];
     ...
     * Sets lang_code
     *
     * @param string $lang_code Language Code (ISO 639-1) for this translation. Has to be a valid lang code that the shop has setup.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The name of this order status
     *
     * @return $this
     */
